#include <egraph_xy/egraph_xy_node.h>
...
bool EGraphXYNode::makePlan(egraph_xy::GetXYPlan::Request& req, egraph_xy::GetXYPlan::Response& res){
  costmap_ros_->clearRobotFootprint();
  costmap_ros_->getCostmapCopy(cost_map_);
...
int main(int argc, char** argv){
  ros::init(argc, argv, "egraph_xy_node");
