...
namespace monolithic_pr2_planner {
     ...
     */
    class FullBodyAdaptiveMotionPrimitive : public MotionPrimitive {
        public:
            ...
            // TODO yuck
            static void goal(GraphState* goal) { m_goal = goal; };
            static GraphState* goal() { return m_goal; };
        ...
        private:
            ...
            void computeIntermSteps(const GraphState& source_state,
                                    ...
                                    TransitionData& t_data);
            static GraphState* m_goal;
    };
    typedef boost::shared_ptr<FullBodyAdaptiveMotionPrimitive> FullBodyAdaptiveMotionPrimitivePtr;
