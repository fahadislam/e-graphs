...
namespace monolithic_pr2_planner {
    ...
    class DiscObjectState : public OccupancyGridUser {
        public:
            ...
            std::vector<int>::const_iterator getCoordBegin(){ return m_coord.begin(); };
            std::vector<int>::const_iterator getCoordEnd(){ return m_coord.end(); };
            ...
            vector<int> getCoords(){ return m_coord; };
