...
namespace monolithic_pr2_planner {
    class RobotState {
        public:
            ...
            void visualize();
            void visualize(int hue, string ns);
            ...
            static bool jointSpaceInterpolate(const RobotState& start, const RobotState& end,
        ...
        private:
            ...
            ContObjectState m_obj_state_rel_map; // this is in MAP frame!
    };
