...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.return_first_solution is None:
      ...
      if self.use_ompl is None:
        self.use_ompl = False
      if self.use_kd_heuristic is None:
        self.use_kd_heuristic = False
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d2B6d3B.pack(_x.larm_object.pose.position.x, _x.larm_object.pose.position.y, _x.larm_object.pose.position.z, _x.larm_object.pose.orientation.x, _x.larm_object.pose.orientation.y, _x.larm_object.pose.orientation.z, _x.larm_object.pose.orientation.w, _x.use_ompl, _x.use_kd_heuristic, _x.initial_eps, _x.final_eps, _x.dec_eps, _x.egraph_eps, _x.final_egraph_eps, _x.dec_egraph_eps, _x.use_egraph, _x.feedback_path, _x.save_egraph))
...
class GetMobileArmPlanResponse(genpy.Message):
  _md5sum = "228930c6ce35d06fb7b6d0b66b08d938"
...
"""
  __slots__ = ['trajectory','body_trajectory','stats_field_names','stats','stat_names','stat_values']
  _slot_types = ['trajectory_msgs/JointTrajectory','trajectory_msgs/JointTrajectory','string[]','float64[]','string[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       trajectory,body_trajectory,stats_field_names,stats,stat_names,stat_values
