...
Node::Node(ros::NodeHandle nh) : m_env(new EGraphEnvironment(nh)), m_env_interface(m_env,
  nh){
    ...
    //m_env_interface.bindCollisionSpaceToTopic("null");
}
...
int main(int argc, char** argv){
    ...
    Node node(nh);
    ROS_INFO("Please wait for the planner to receive info from topics");
